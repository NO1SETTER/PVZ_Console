...
char plantName[20][20]={"向日葵","豌豆射手","坚果","冰射手","双发射手","窝瓜","高坚果","樱桃炸弹","大蒜","南瓜头"};
...
char plantColor[20][20] = {ANSI_LIGHT_YELLOW,ANSI_GREEN,ANSI_YELLOW,ANSI_LIGHT_BLUE,ANSI_GREEN,
ANSI_LIGHT_CYAN,ANSI_YELLOW,ANSI_RED,ANSI_LIGHT_CYAN,ANSI_YELLOW};
